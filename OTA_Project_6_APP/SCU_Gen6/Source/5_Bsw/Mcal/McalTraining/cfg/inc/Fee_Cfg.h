...
#ifdef FeeConf_FeeBlockConfiguration_ReprogrammingAttemptCounter 
/* to prevent double declaration */
#error FeeConf_FeeBlockConfiguration_ReprogrammingAttemptCounter already defined
#else 
#define FeeConf_FeeBlockConfiguration_ReprogrammingAttemptCounter ((uint16)11)
#endif /* #ifdef FeeConf_FeeBlockConfiguration_ReprogrammingAttemptCounter */

#ifdef FeeConf_FeeBlockConfiguration_ReprogrammingSuccessCounter 
/* to prevent double declaration */
#error FeeConf_FeeBlockConfiguration_ReprogrammingSuccessCounter already defined
#else 
#define FeeConf_FeeBlockConfiguration_ReprogrammingSuccessCounter ((uint16)12)
#endif /* #ifdef FeeConf_FeeBlockConfiguration_ReprogrammingSuccessCounter */
