...
void EA_readNvmData(uint16 block, P_uint8 data) {
    ...
    else if(block == DATA_ID_ReprogrammingAttemptCounter) {
        length = DATA_LEN_ReprogrammingAttemptCounter;
    }
    else if(block == DATA_ID_ReprogrammingSuccessCounter) {
        length = DATA_LEN_ReprogrammingSuccessCounter;
    }
