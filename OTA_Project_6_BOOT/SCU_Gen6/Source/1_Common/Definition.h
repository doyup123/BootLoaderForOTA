...
#define MEMORY_SIZE_APPLICATION             ((512*1024) - MEMORY_DATA_VALID_PATTERN_LENGTH)//7ffe0
#define MEMORY_PATTERN_VALID_APP_ADDR       (MEMORY_ADDRESS_APPLICATION + MEMORY_SIZE_APPLICATION)//8017ffe0

#define MEMORY_SECONDARY_OFFSET             (512*1024)

#define MEMORY_SIZE_SIGNATURE 32u

#define MEMORY_SIZE_SIGN_KEY 32u

#define DATA_ID_ReprogrammingAttemptCounter     11u

#define DATA_ID_ReprogrammingSuccessCounter     12u
#define DATA_LEN_ReprogrammingAttemptCounter    2u
#define DATA_LEN_ReprogrammingSuccessCounter    2u
