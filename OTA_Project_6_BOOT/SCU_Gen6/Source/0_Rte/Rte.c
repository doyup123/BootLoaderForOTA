...
void Rte_Call_BswDcm_rEcuAbsFls_copyPflashSector(uint8 pflashAreaTarget, uint8 pflashAreaSource, P_uint8 errorResult) {
    REoiEcuAbs_pEcuAbsFls_copyPflashSector(pflashAreaTarget, pflashAreaSource, errorResult);
}
