...
derivative my_tc23x extends tc23x
{
    ...
    memory pspr0 (tag="on-chip")
    {
        ...
        type = ram;
        size = 8k;
        map (dest=bus:tc0:fpi_bus, dest_offset=0xC0100000, size=8k);
    ...
    memory pflash_app_valid(tag="on-chip")
    /* for MEMORY_PATTERN_VALID_APP_VALUE */
    {
        mau = 8;
        type = reserved rom;
        size = 32;
...
section_layout :vtc:linear
{
    ...
    group flsfuncgrp (ordered, align = 4, run_addr = mem:mpe:pspr0, copy)
    {
